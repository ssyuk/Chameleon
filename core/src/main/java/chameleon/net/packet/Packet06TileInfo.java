...
public class Packet06TileInfo extends Packet {
    private final Location tileLocation;
    private final Tile tile;
    private final int height;

    public Packet06TileInfo(MessageUnpacker unpacker) {
        try {
    ...
    public Packet06TileInfo(Location location, Tile tile, int height) {
